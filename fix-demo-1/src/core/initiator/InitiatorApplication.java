...
public class InitiatorApplication implements Application {
	...
	public void fromAdmin(Message arg0, SessionID arg1)
		...
		// your FIX engine
		System.out.println("[initiator] successfully called fromAdmin() for sessionId: " + arg1);
		System.out.println();
	}
	...
	public void fromApp(Message arg0, SessionID arg1)
		...
		System.out.println("[initiator] successfully called fromApp() for sessionId: " + arg1);
		System.out.println();
	}
	...
	public void onCreate(SessionID arg0) {
		...
		System.out.println("[initiator] successfully called onCreate() for sessionId: " + arg0);
		System.out.println();
	...
	public void onLogon(SessionID arg0) {
		...
		System.out.println("[initiator] successfully logged on for sessionId: " + arg0);
		System.out.println();
	}
	...
	public void onLogout(SessionID arg0) {
		...
		System.out.println("[initiator] successfully logged out for sessionId: " + arg0);
		System.out.println();
	}
	...
	public void toAdmin(Message arg0, SessionID arg1) {
		...
		System.out.println("[initiator] Inside toAdmin()");
		System.out.println();
	...
	public void toApp(Message arg0, SessionID arg1) throws DoNotSend {
		...
		System.out.println("[initiator] [toApp()] Message : " + arg0 + " for sessionid : " + arg1);
		System.out.println();
	}
