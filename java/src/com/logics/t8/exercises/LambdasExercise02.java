 ...
 */
package com.logics.t8.exercises;
...
public class LambdasExercise02 {
    ...
    /**
     * Exercise 2: Find products by category by implementing a functional interface
     * using a lambda expression and calling it.
     *
    ...
    public List<Product> findProductsByCategory(List<Product> products, Category category) {
        ...
        // The lambda expression should return true if the product is in the given
        // category
