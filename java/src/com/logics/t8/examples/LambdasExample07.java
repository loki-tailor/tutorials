...
public class LambdasExample07 {
    ...
    public static void main(String[] args) {
        ...
        // Instead of a lambda expression, you can use a method reference to refer to a
        // method
        // that implements the relevant functional interface.
        // products.forEach(product -> System.out.println(product));
        products.forEach(System.out::println);

        // A method reference can refer to a static method, an instance method or a
        // constructor.
        ...
        // - Product::getName refers to an instance method of class Product, but not for
        // any particular Product object
        // map() calls the getName() method on the Product object it receives
        // - System.out::println refers to an instance method of class PrintStream, for
        // a particular PrintStream object;
        // the one that the variable System.out refers to. forEach() calls the println()
        // method on that PrintStream
