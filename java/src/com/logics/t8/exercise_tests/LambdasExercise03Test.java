 ...
 */
package com.logics.t8.exercise_tests;

import static com.logics.t8.Category.CLEANING;
import static com.logics.t8.Category.FOOD;
import static com.logics.t8.Category.OFFICE;
import static com.logics.t8.Category.UTENSILS;
...
import com.logics.t8.exercises.LambdasExercise03;
...
class LambdasExercise03Test {
        ...
        void useShoppingCart() {
                ...
                assertThat(factory).describedAs(
                                "Exercise 3: Your getShoppingCartFactory() does not return a shopping cart factory.")
