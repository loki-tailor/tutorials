...
class BasicStreamsExercise03Test {
    ...
    void findProductCheaperThan() {
        Optional<Product> result = exercise.findProductCheaperThan(com.pluralsight.streamslambdas.exercises.TestData.getProducts(), new BigDecimal("4.00"));
        assertThat(result)
        ...
        assertThat(exercise.findProductCheaperThan(com.pluralsight.streamslambdas.exercises.TestData.getProducts(), new BigDecimal("1.00")))
