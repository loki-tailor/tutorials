...
const cookie2 = {
  ...
  isSweet: true,
  "+abcde":
    "property which can be accessible only with square-bracket, since it is having special chars in beginning",

  // funciton in side object-literals
  eatCookie: function () {
    // 'funciton() is mandatory
    console.log(
      "i am a function from 'object literal': i am eating @ " + this.name
    );
  },
};
...
// object with classes
class Cookie {
  constructor(name, short_name, isSweet, _abcde) {
    this.name = name;
  ...
  /*- NOTE: JavaScript doesn't have function overloading, including for methods or constructors. 
  ...
  */
  ...
  eatCookie() {
    console.log(
      "i am a function inside a class & outside a constructor : i am eating @ " +
        this.name
    );
  }
}
...
const cookie_obj_2 = new Cookie("Honey Oats", "HO", true, "hehehe..hahaha..");
console.log(cookie_obj_2);
console.log(cookie_obj_2._abcde);
console.log(cookie_obj_2["_abcde"]);
console.log("###########################################");
