/*-
    - below will create the application
...
/*-
    ...
    - the wait is applied to the return value of the function call and not on the function itself
    - hence we will will only have to pass the function and not function call i.e. exclude ()

*/
// setTimeout(autoTodo.utils_create_todo("abc"), 1000); // won't do anything
...
// correct way #3: no depenency on extrernal objects / functions
for (i = 0; i < 100; i++) {
